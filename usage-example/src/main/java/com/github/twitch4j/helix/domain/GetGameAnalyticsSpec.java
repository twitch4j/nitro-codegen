...
public class GetGameAnalyticsSpec {
     ...
     * Process Spec
     */
    public static GetGameAnalyticsSpec process(Consumer<GetGameAnalyticsSpec> spec) {
        GetGameAnalyticsSpec data = new GetGameAnalyticsSpec();
        spec.accept(data);
        data.validate();
        return data;
    }
    ...
    public void validate() {
        ...
        Objects.requireNonNull(gameId, "gameId is a required parameter!");
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec authorization(String authorization) {
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec startedAt(String startedAt) {
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec endedAt(String endedAt) {
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec gameId(String gameId) {
        this.gameId = gameId;
        return this;
    }
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec type(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec after(String after) {
        this.after = after;
        return this;
    }
     ...
     * @return GetGameAnalyticsSpec
     */
    public GetGameAnalyticsSpec first(Integer first) {
        this.first = first;
        return this;
    }
